...
(function( window, undefined ) {
    ...
    auiSharebox.prototype = {
        ...
        open: function(params,callback) {
            var shareboxHtml='',buttonsHtml='',headHtml='',contentHtml='';
        	  var self = this;
            ...
            if(self.headTitle) {
              headHtml = '<div class="aui-row-head">'+this.headTitle+'</div>';
            }
            self.shareBoxDiv.innerHTML += headHtml;
            // if(self.content) {
              contentHtml = '<div class="aui-row aui-row-content"><div class="share_img"><img src="/Public/Home/images/card.png" /></div><div class="share_txt"><div class="txt1">小伙伴打开你的分享链接，参加活动报名或阅读次数达到一定数量，均可获得相应冰币。</div><div class="txt2">（冰币当钱花，还可换礼品嗷）</div></div></div>';
            // }
            self.shareBoxDiv.innerHTML += contentHtml;
